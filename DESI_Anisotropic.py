...
OUTPUT_ROOT = Path(os.environ.get("ADPD_OUTPUT_DIR", "."))
...
#For anisotropic run
#LA_AXIS = 67.65      # degrees
#BA_AXIS = 50.60      # degrees
#OM_K0  = 3e-7
...
def plot_adpd_variance_summary(
    ...
    *,
    ...
    np.savetxt(
        os.path.join(COMPARISON_DIR, "desi.dat"),
    ...
    if include_s2 and results.get("S2") is not None:
        ...
        np.savetxt(
            os.path.join(COMPARISON_DIR, "s2_fiducial_plot.dat"),
    ...
    if include_DM and len(results["DM"]) > 0:
        ...
        np.savetxt(
            os.path.join(COMPARISON_DIR, "dm_particles.dat"),
    ...
    for case in cases_to_plot:
        ...
        np.savetxt(
            os.path.join(COMPARISON_DIR, f"{filename}.dat"),
...
# ---------------------------------------------------------------------------
    ...
    np.savetxt(
        os.path.join(COMPARISON_DIR, "test.dat"),
...
def plot_adpd_variance_summary(
    ...
    *,
    ...
    # DESI
    np.savetxt(
        os.path.join(COMPARISON_DIR, "desi_plot.dat"),
